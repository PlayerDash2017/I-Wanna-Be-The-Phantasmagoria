...
//World
global.startRoom = rMenuCharacter;         //Sets which room to begin with
global.roomCaptionDef = "I Wanna Be The Phantasmagoria";  //Sets default window caption (only works with the Professional version of Studio)
